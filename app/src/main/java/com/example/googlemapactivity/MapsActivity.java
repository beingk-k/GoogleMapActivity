...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        latlngs.add(new LatitudeLongitude(27.705932, 85.329856, "Softwarica College"));
        latlngs.add(new LatitudeLongitude(27.70482, 85.3293997, "MaalBhai Chya"));
        latlngs.add(new LatitudeLongitude(27.700771, 85.330740, "MaalDai Mo:Mo"));
